...
<span itemscope itemtype="http://schema.org/SoftwareApplication"><header id="header">
  <div class="top_links">
    <div class="container">
      <div class="language">
        <?php ?>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.FloatPosition.TOP_RIGHT, multilanguagePage: true, gaTrack: true, gaId: 'UA-68916902-1'}, 'google_translate_element');
}
      ...
      <ul>
        ...
        <li class="first logged"> <span><i class="fa fa-user"></i> <?php echo sprintf(__('Hi %s', OSCLASSWIZARDS_THEME_FOLDER), osc_logged_user_name() . '!'); ?> </span> &#10072; <strong><a href="<?php echo osc_user_dashboard_url(); ?>">
          <?php _e('Lihat Toko Saya', OSCLASSWIZARDS_THEME_FOLDER); ?>
  ...
  <div class="main_header" id="main_header">
    <div class="container">
      ...
      <div class="publish">
        ...
        <a class="btn btn-success" href="https://www.iklanjualbelionline.com/"> <i class="fa fa-shopping-cart"></i></i>
        <?php _e('Beli Barang ', OSCLASSWIZARDS_THEME_FOLDER);?>
        </a>
        <a class="btn btn-success" href=" "><i class="fa fa-hand-o-right"></i></i>
        <?php _e('Jual di Toko', OSCLASSWIZARDS_THEME_FOLDER);?>
        </a>
        <a class="btn btn-success" href="<?php echo osc_item_post_url_in_category() ; ?>"><i class="fa fa-bullhorn"></i></i>
        <?php _e('Pasang Iklan ', OSCLASSWIZARDS_THEME_FOLDER);?>
        </a>
        <?php } ?>
      </div>
    </div>
  ...
  <div id="header_map">
    <?php
			if(homepage_image()) { 
				...
				echo '<img itemprop="image" src="'.osc_current_web_theme_url('images/banner.jpg').'" />';
